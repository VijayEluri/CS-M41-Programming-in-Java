// This of a copy of class Board as of 7.12.2010 
// (ID 799553683f7a758ab03610163ce3602081564a35)
// for exercise purposes. "Board" has thus be renamed to "BoardUsage".

class BoardUsage extends Board {
    ...
    public BoardUsage() { // standard position
        M = new Moves(this);
        board = new char[N][N];
        fromFEN(initial_position);
    }
    public BoardUsage(final String fen_position) {
        M = new Moves(this);
        board = new char[N][N];
    ...
    public boolean equals(final BoardUsage other) {
        for (int x = 0; x <= 7; ++x)
            for (int y = 0; y <= 7; ++y)
    ...
    public static void main(final String[] args) {
        final BoardUsage B = new BoardUsage();
